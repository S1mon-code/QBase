...
每个 Portfolio 用 **0-100 综合评分**，覆盖 4 个维度：

### 评分维度与权重

| 维度 | 权重 | 包含指标 |
|------|:----:|---------|
| **收益风险比** | 35% | Sharpe, Calmar, MaxDD, 回撤持续时间 |
| **组合质量** | 30% | 平均相关性, Portfolio/最佳单策略比, 正Sharpe策略占比 |
| **稳健性** | 20% | 跨品种一致性 (多少个品种 Sharpe > 1.0) |
| **实操性** | 15% | 策略数量, 最大单策略权重, 频率多样性 |
