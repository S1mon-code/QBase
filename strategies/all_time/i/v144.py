...
class StrategyV144(TimeSeriesStrategy):
    """
    MTF: daily EMA(20/60) cross + 4h CCI reversal entry.
    Large TF: EMA20 > EMA60. Small TF: CCI crosses from extreme.
    Strengths: EMA cross robust, CCI reversals. Weaknesses: EMA lags.
    """
    name = "i_alltime_v144"
    freq = "4h"
    warmup = 500
