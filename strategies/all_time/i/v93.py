...
class StrategyV93(TimeSeriesStrategy):
    """
    策略简介：NR7窄幅整理 + Aroon趋势方向 + CMF资金流向的4h突破策略。

    使用指标：
    - NR7: 7根K线内最窄振幅，盘整末期标志
    - Aroon(25): 趋势方向确认
    - CMF(20): Chaikin资金流向确认
    - ATR(14): 止损距离
