...
class StrategyV151(TimeSeriesStrategy):
    """
    MTF: daily Supertrend + 4h Bollinger mean reversion entry.
    Large TF: ST bullish. Small TF: price < lower BB (long).
    Strengths: trend-aligned reversion. Weaknesses: BB compressed.
    """
    name = "i_alltime_v151"
    freq = "4h"
    warmup = 500
