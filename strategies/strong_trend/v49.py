...
class StrongTrendV49(TimeSeriesStrategy):
    ...
    def on_bar(self, context):
        ...
        lookback = max(self.warmup, self.hurst_lag + 30, self.st_period + 10)
        ...
        # ----- Compute indicators -----
        hurst_vals = hurst_exponent(closes, max_lag=self.hurst_lag)
        ...
        vol_spike_recent = bool(np.any(vol_spikes[-3:]))
